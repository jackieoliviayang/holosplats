...
def main():
    ply_file = 'outputs/nerfstudio_data/splatfacto/2024-10-16_163321/splat.ply'  # Updated file path
    output_file = 'extracted_gaussian_data.json'  # Name of the output JSON file
